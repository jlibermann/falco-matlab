...
mp.Fend.corr.Rout  = 8;  % outer radius of dark hole correction region [lambd
...
% mp.Fend.xiOffset = -7; % Offset DH such that it overlaps fiber pos
...
[mp.dm1.fourier_basis_xis , mp.dm1.fourier_basis_etas] = falco_choose_fourier_locations_polar(...
    mp.dm1.Nact/2, mp.dm1.fourier_spacing, mp.dm1.fourier_gridType, xiMin, mp.Fend.corr.Rout, mp.Fend.corr.ang, clocking, xiMin);
% [mp.dm1.fourier_basis_xis , mp.dm1.fourier_basis_etas] = falco_choose_fourier_locations_polar(...
%     mp.dm1.Nact/2, mp.dm1.fourier_spacing, mp.dm1.fourier_gridType, mp.Fend.corr.Rin, mp.Fend.corr.Rout+1, mp.Fend.corr.ang, clocking); % Remove knife edge from actuator pos.
