...
% % indsZnoll = 2:3; % Test low order aberrations (tip/tilt)
...
% 
% % Aberrated E-fields
% mp.P1.compact.E = exp(1j * 2 * pi / mp.lambda0 * zern_error_rms * ZmapCompact_norm.ZmapCompact_norm);
% mp.P1.full.E = exp(1j * 2 * pi / mp.lambda0 * zern_error_rms * ZmapFull_norm.ZmapFull_norm);
