...
% mp.Fend.corr.Rout  = 5;  % Josh: Changed outer radius of DH
...
% mp.Fend.score.Rout = 5; % Josh: Changed outer radius of scoring region
...
mp.dm1.Nactbeam = (mp.dm1.Nact-s2); % Number of actuators across the beam (approximate)
